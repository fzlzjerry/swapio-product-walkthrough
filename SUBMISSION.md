...
Character count: 251 (before X's media attachment metadata).
...
- [x] Public video is at least 30 seconds (verified: 60.000 seconds video).
- [x] Shows the real Swap.io product rather than a logo-only concept.
- [x] Includes original analysis and narration.
